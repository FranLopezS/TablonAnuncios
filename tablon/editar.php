...
<div class='colocarfor'>
	<form name="iniciosesion" action="procesa_editar.php" method ="POST">
		<table border='3' align=center class="table table-dark">
			<tr><td><b>Título</b></td><td><input type="text" value='<?php echo "$titulo"; ?>' name="titulo" maxlength="30" required></td></tr>
			<tr><td><b>Cuerpo</b></td><td><textarea name="cuerpo" maxlength="800" rows="10" cols="40" required><?php echo "$cuerpo"; ?></textarea></td></tr>
			...
			<tr><td><b>Fecha de finalización</b></td><td><input type='date' name="fechafin" value='<?php echo "$fechaf"; ?>' required></td></tr>
