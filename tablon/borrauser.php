...
<div class='colocarfor'>
	<form name="iniciosesion" action="procesa_borraruser.php" method ="POST">
		<table border='3' align=center class="table table-dark">
			<tr><td><b>Nombre y apellidos</b></td><td><input type="text" value='<?php echo "$nya"; ?>' name="nya" readonly></td></tr>
			<tr><td><b>Email</b></td><td><input name="email" value='<?php echo "$email"; ?>' readonly /></td></tr>
			<tr><td><b>Permiso</b></td><td><input type="number" name='permiso' max='2' min='1' value='<?php echo "$permiso"; ?>' readonly></td></tr>
